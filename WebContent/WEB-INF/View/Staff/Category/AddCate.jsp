...
<head>
    ...
    <title>Staff Add Category</title>
 	<link rel="stylesheet" href="css/Staff/Category/AddCate.css">
...
<body>
    <div class="page">
        ...
        <div class="right">
            ...
            <div class="body">
                <h3 class="body-name">Thêm mới Danh mục</h3>
                <div class="body-category">
                 <form class="form-add" method ="post" action="http://localhost:8080/Food_Shop/AddCate">
                        <br>
                        <div class="form-add-item">
                            Mã Danh mục :<br>
                            <input type="text" name="idCate" placeholder="Nhập mã danh mục">
                        </div> <br><br>
                        <div class="form-add-item">
                            Tên Danh muc:<br>
